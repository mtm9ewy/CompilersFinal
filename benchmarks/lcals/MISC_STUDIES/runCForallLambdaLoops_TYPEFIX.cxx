...
//
// Source file containing LCALS "C" subset forall lambda loops
               ...
               for ( k=1 ; k<kn ; k++ ) {
                  ...
                  [&] (Index_type j) {
                     ...
                     tza[k][j] = ( tzp[k+1][j-1] +tzq[k+1][j-1] -tzp[k][j-1] -tzq[k][j-1] )*
                                 ( tzr[k][j] +tzr[k][j-1] ) / ( tzm[k][j-1] +tzm[k+1]
[j-1]);              tzb[k][j] = ( tzp[k][j-1] +tzq[k][j-1] -tzp[k][j] -tzq[k][j] ) *
