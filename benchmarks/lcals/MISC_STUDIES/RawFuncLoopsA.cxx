...
//
// Source file containing LCALS "A" subset raw loops implemented in
...
#if defined(XLC_ALIGN_DECORATE)
         __alignx(LCALS_DATA_ALIGN, in);
         __alignx(LCALS_DATA_ALIGN, out);
         __alignx(LCALS_DATA_ALIGN, coeff);
#endif
