...
//
// Source file containing LCALS "A" subset forall hybrid lambda loops
...
//
          ...
          case VOL3D_CALC : {
            ...
            HybridIndexSet his;
            his.addRangeIndices(domain.fpz, domain.lpz + 1);
          ...
          case DEL_DOT_VEC_2D : {
            ...
            HybridIndexSet his;
            his.addRangeIndices(0, domain.n_real_zones);
          ...
          case FIR : {
            ...
            HybridIndexSet his;
            his.addRangeIndices(0, len_minus_coeff);
...
#endif  // if OMPILE_LAMBDA_VARIANTS
